List<Map<String, dynamic>> dataList = [
  ...
  {
    'location': 'CANDONI, PHILIPPINES',
    'crops': [
      {
        'name': 'Pineapple, Rice, Sugarcane',
        'duration': 'September to December'
      },
      {'name': 'Rice, Pineapple, Sugarcane', 'duration': 3},
      {'name': 'Sugarcane, Pineapple, Corn', 'duration': 1}
    ]
  },
  {
    'location': 'CAUYAN, PHILIPPINES',
    'crops': [
      {'name': 'Rice, Corn, Coconut', 'duration': 3},
      {'name': 'Corn, Rice, Coconut', 'duration': 4},
      {'name': 'Coconut, Rice, Corn', 'duration': 4}
    ]
  },
  {
